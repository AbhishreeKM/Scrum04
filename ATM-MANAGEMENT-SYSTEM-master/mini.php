         ...
         <div class="row">
            ...
            <div class="row">
                <h7><br> <b><div class="col-xs-2">Balance: </div>
                               <div class="col-xs-10"><?php echo $row['balance']; ?> </div><br><br></b></h7> 
                   </div>
    <div class="row">
        <h7><br> <b><div class="col-xs-2">Transaction date: </div>
                       <div class="col-xs-10"><?php echo $row["transaction_date"]; ?> </div><br><br></b></h7> 
        </div>
    <div class="row">
        <h7><br> <b><div class="col-xs-2">Transaction id: </div>
                       <div class="col-xs-10"><?php echo $row['transaction_id']; ?> </div><br><br></b></h7>
    </div>
    <div class="row">
        <h7><br> <b><div class="col-xs-2">Bank Name: </div>
                  <div class="col-xs-10"><?php echo $row["bank_name"]; ?> </div><br><br></b></h7> 
        </div>
    <div class="row">
        <h7><br> <b><div class="col-xs-2">Branch Location: </div>
                       <div class="col-xs-10"><?php echo $row["branch_location"]; ?> </div><br><br></b></h7> 
        </div><br><br>
